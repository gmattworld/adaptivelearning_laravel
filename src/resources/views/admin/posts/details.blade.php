                ...
                <div class="tab-pane active" id="tab_3">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>{{ $model->topic }} Post Info.</div>
                            <div class="tools">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('topic', $model->topic, ['class'=>'form-control', 'readonly'=>'readonly']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('is_active', $model->is_active ? 'Active' : 'Disabled', ['class'=>'form-control', 'readonly'=>'readonly']) !!}
                                        ...
                                        <div class="col-md-offset-2 col-md-8">
                                            <div class="row">
                                                <div class="text-right">
                                                    <a href="{{ URL('/admin/posts/'. $model->id .'/status') }}" class="btn {{ $model->is_active ? 'red' : 'green' }}">{{ $model->is_active ? 'Disable' : 'Enable' }}</a>
                                                    <a href="{{ URL('/admin/posts/'. $model->id .'/edit') }}" class="btn blue">Edit</a>
                                                    <a href="{{ URL('/admin/posts/') }}" class="btn default">Return to list</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
