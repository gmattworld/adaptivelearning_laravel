        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Lawyers Management</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ URL('/admin/lawyers/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        @if(count($model) > 0)
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7" class="text-center"> <h3>No Lawyer created yet</h3> </td></tr>
                        @endif
                    </tbody>
                </table>
            </div>
