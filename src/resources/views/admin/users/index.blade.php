            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ URL('/admin/users/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="{{ URL('/admin/users/'. $item->id) }}"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/users/'. $item->id .'/status') }}"><i class="icon-key"></i> {{ $item->is_logged_out ? 'Disable' : 'Enable' }} </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/users/'. $item->id .'/edit') }}"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
