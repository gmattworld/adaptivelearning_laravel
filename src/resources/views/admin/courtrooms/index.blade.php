        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class="icon-courtroom font-dark"></i>
                    <span class="caption-subject bold uppercase"> Court Rooms Management</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ URL('/admin/courtrooms/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        @if(count($model) > 0)
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="{{ URL('/admin/courtrooms/'. $item->id) }}"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/courtrooms/'. $item->id .'/status') }}"><i class="icon-key"></i> {{ $item->is_active ? 'Disable' : 'Enable' }} </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/courtrooms/'. $item->id .'/edit') }}"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7" class="text-center"> <h3>No Court Room created yet</h3> </td></tr>
                        @endif
                    </tbody>
                </table>
            </div>
