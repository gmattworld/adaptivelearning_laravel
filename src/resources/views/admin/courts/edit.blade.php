    ...
    <div class="col-md-12">
        <div class="tabbable-line boxless tabbable-reversed">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab_2" data-toggle="tab"> Edit Court Branch </a>
                </li>
            </ul>
                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            {!! Form::open(['action' => ['CourtController@update', $model->id], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']) !!}
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('contact_person', $model->contact_person, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Contact Person']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::tel('contact_phone', $model->contact_phone, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Contact Phone']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::email('contact_email', $model->contact_email, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Contact Email']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('longitude', $model->longitude, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Longitude']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('latitude', $model->latitude, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Latitude']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::textarea('address', $model->address, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Address']) !!}
