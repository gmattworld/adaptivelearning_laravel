...
@section('pageheader')
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title"> Clients Management
        <small></small>
    </h1>
    <div class="page-bar">
        ...
        <div class="page-toolbar">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    ...
                    <li>
                        <a href="#">
                            <i class="icon-client"></i> Something else here</a>
                    </li>
                    <li class="divider"> </li>
                    <li>
                        <a href="#">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class="icon-client font-dark"></i>
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ URL('/admin/clients/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        @if(count($model) > 0)
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="{{ URL('/admin/clients/'. $item->id) }}"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/clients/'. $item->id .'/status') }}"><i class="icon-key"></i> {{ $item->is_active ? 'Disable' : 'Enable' }} </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/clients/'. $item->id .'/edit') }}"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7" class="text-center"> <h3>No Client created yet</h3> </td></tr>
                        @endif
                    </tbody>
                </table>
            </div>
