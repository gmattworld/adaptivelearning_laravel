        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Archives Management</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="{{ URL('/admin/archives/create') }}" id="sample_editable_1_new" class="btn sbold green"> Add New
                        ...
                        @if(count($model) > 0)
                            @foreach($model as $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{!! $item->name !!}</td>
                                    <td>{!! $item->cases->name !!}</td>
                                    <td>{!! $item->cases->category->name !!}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="{{ URL('/admin/archives/'. $item->id) }}"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="{{ URL('/admin/archives/'. $item->id .'/edit') }}"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7" class="text-center"> <h3>No Archive created yet</h3> </td></tr>
                        @endif
                    </tbody>
                </table>
            </div>
