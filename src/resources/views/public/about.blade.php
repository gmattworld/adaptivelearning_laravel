    ...
    <div class="about">
        <div class="container">
            <div class="row about_row row-lg-eq-height">
                ...
                <div class="col-lg-6">
                    <div class="about_image"><img src="{{ URL::asset('client/images/about_1.jpg') }}" alt="https://unsplash.com/jtylernix"></div>
                </div>
            </div>
            <div class="row about_row row-lg-eq-height">
                <div class="col-lg-6 order-lg-1 order-2">
                    <div class="about_image"><img src="{{ URL::asset('client/images/about_1.jpg') }}" alt=""></div>
                </div>
    ...
    <div class="teachers">
        <div class="container">
            ...
            <div class="row teachers_row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="teacher">
                        <div class="teacher_image"><img src="{{ URL::asset('client/images/teacher_2.jpg') }}" alt="https://unsplash.com/rawpixel"></div>
                        <div class="teacher_body text-center">
...
@section('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('client/styles/about.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('client/styles/about_responsive.css') }}">
@endsection
...
@section('scripts')
    ...
    <script src="{{ URL::asset('client/js/about.js') }}"></script>
@endsection
