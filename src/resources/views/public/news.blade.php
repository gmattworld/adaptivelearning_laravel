        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="news_posts">
                    ...
                    <!-- News Post -->
                    <div class="news_post">
                        <div class="news_post_image"><img src="{{ URL::asset('client/images/news_5.jpg') }}" alt=""></div>
                    ...
                    <!-- News Post -->
                    <div class="news_post">
                        <div class="news_post_image"><img src="{{ URL::asset('client/images/news_6.jpg') }}" alt=""></div>
                        <div class="news_post_body">
                            <div class="news_post_date"><a href="#">April 02, 2018</a></div>
                    ...
                    <!-- News Post -->
                    <div class="news_post">
                        <div class="news_post_image"><img src="{{ URL::asset('client/images/news_7.jpg') }}" alt=""></div>
                        <div class="news_post_body">
                            <div class="news_post_date"><a href="#">April 02, 2018</a></div>
                    ...
                    <div class="sidebar_latest_posts">
                        ...
                        <div class="latest_posts">
                            ...
                            <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="latest_post_image"><img src="{{ URL::asset('client/images/news_1.jpg') }}" alt="https://unsplash.com/beccatapert"></div></div>
                            ...
                            <!-- News Post -->
                            <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="latest_post_image"><img src="{{ URL::asset('client/images/news_2.jpg') }}" alt="https://unsplash.com/nbb_photos"></div></div>
                                <div class="latest_post_body">
                                    <div class="latest_post_date">April 02, 2018</div>
                            ...
                            <!-- News Post -->
                            <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="latest_post_image"><img src="{{ URL::asset('client/images/news_3.jpg') }}" alt="https://unsplash.com/rawpixel"></div></div>
                                <div class="latest_post_body">
                                    <div class="latest_post_date">April 02, 2018</div>
                                    <div class="latest_post_title"><a href="news.html">Why Choose online education?</a></div>
                                    <div class="latest_post_author">By <a href="#">William Smith</a></div>
                            ...
                            <!-- News Post -->
                            <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="latest_post_image"><img src="{{ URL::asset('client/images/news_4.jpg') }}" alt="https://unsplash.com/jtylernix"></div></div>
                                <div class="latest_post_body">
                                    <div class="latest_post_date">April 02, 2018</div>
                                    <div class="latest_post_title"><a href="news.html">Books, Kindle or tablet?</a></div>
                                    <div class="latest_post_author">By <a href="#">William Smith</a></div>
