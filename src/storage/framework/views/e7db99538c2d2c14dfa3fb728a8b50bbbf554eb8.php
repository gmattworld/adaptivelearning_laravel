...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #2 | 404 Page Option 3</title>
        ...
        <link href="<?php echo e(URL::asset('admin/assets/pages/css/error.min.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="<?php echo e(URL::asset('admin/favicon.ico')); ?>" /> </head>
    <!-- END HEAD -->

    <body class=" page-404-3">
        <div class="page-inner">
            <img src="<?php echo e(URL::asset('admin/assets/pages/media/pages/earth.jpg')); ?>" class="img-responsive" alt=""> </div>
...
<?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/errors/404.blade.php ENDPATH**/ ?>