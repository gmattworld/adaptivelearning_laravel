                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php echo Form::open(['action' => 'DashboardController@save_adaptive', 'files'=>true, 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::select('read_type', array('PDF' => 'Text', 'Audio' => 'Audio', 'Visual' => 'Visual'), '', ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select your favourable reading type']); ?>

                                                    <span class="text-danger"> <?php echo $errors->first('read_type');; ?> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/student/adaptive/test.blade.php ENDPATH**/ ?>