<?php $__env->startSection('pageheader'); ?>
    <!-- BEGIN PAGE HEADER-->
    <h1 class="page-title"> Level Management
        <small></small>
    </h1>
    <div class="page-bar">
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Levels Management</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="<?php echo e(URL('/admin/levels/create')); ?>" id="sample_editable_1_new" class="btn sbold green"> Add New
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/levels/'. $item->id)); ?>"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/levels/'. $item->id .'/status')); ?>"><i class="icon-key"></i> <?php echo e($item->is_active ? 'Disable' : 'Enable'); ?> </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/levels/'. $item->id .'/edit')); ?>"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                        ...
                        <?php else: ?>
                            <tr><td colspan="6" class="text-center"> <h3>No Level created yet</h3> </td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/levels/index.blade.php ENDPATH**/ ?>