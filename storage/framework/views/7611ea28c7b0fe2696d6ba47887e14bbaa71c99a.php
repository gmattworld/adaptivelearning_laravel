    ...
    <div class="col-md-12">
        <div class="tabbable-line boxless tabbable-reversed">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab_2" data-toggle="tab"> Edit Department </a>
                </li>
            </ul>
                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Department Information </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php echo Form::open(['action' => ['DepartmentController@update', $model->id], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <?php echo Form::label('school_id', 'School', ['class'=>'control-label col-md-3']); ?>

                                                <div class="col-md-9">
                                                    <?php echo Form::select('school_id', $schools, $model->school_id, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select School']); ?>

                                                    <span class="text-danger"> <?php echo $errors->first('school_id');; ?> </span>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/departments/edit.blade.php ENDPATH**/ ?>