    ...
    <div class="col-md-12">
        <div class="tabbable-line boxless tabbable-reversed">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab_2" data-toggle="tab"> Edit Level </a>
                </li>
            </ul>
                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php echo Form::open(['action' => ['LevelController@update', $model->id], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            ...
                                            <div class="form-group">
                                                <?php echo Form::label('department_id', 'Department', ['class'=>'control-label col-md-3']); ?>

                                                <div class="col-md-9">
                                                    <?php echo Form::select('department_id', $departments, $model->department_id, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select Department']); ?>

                                                    <span class="text-danger"> <?php echo $errors->first('department_id');; ?> </span>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/levels/edit.blade.php ENDPATH**/ ?>