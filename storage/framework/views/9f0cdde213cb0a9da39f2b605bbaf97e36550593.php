                ...
                <div class="tab-pane active" id="tab_3">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo e($model->name); ?> School Info.</div>
                            <div class="tools">
                                        ...
                                        <div class="col-md-offset-2 col-md-8">
                                            <div class="row">
                                                <div class="text-right">
                                                    <a href="<?php echo e(URL('/admin/schools/'. $model->id .'/status')); ?>" class="btn <?php echo e($model->is_active ? 'red' : 'green'); ?>"><?php echo e($model->is_active ? 'Disable' : 'Enable'); ?></a>
                                                    <a href="<?php echo e(URL('/admin/schools/'. $model->id .'/edit')); ?>" class="btn blue">Edit</a>
                                                    <a href="<?php echo e(URL('/admin/schools/')); ?>" class="btn default">Return to list</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/schools/details.blade.php ENDPATH**/ ?>