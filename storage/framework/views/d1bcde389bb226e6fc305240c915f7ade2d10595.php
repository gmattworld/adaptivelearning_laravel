                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <?php echo Form::open(['action' => 'ResourceController@store', 'files'=>true, 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::select('course_id', $courses, null, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select Course']); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::select('subject_id', $subjects, null, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select Subject']); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::file('pdf_path', ['class'=>'form-control', 'required'=>'required']); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::file('video_path', ['class'=>'form-control', 'required'=>'required']); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo Form::file('audio_path', ['class'=>'form-control', 'required'=>'required']); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <?php echo Form::textarea('description', '', ['class'=>'form-control', 'required'=>'required', 'id'=>'article-ckeditor', 'placeholder'=>' Description']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/cresources/create.blade.php ENDPATH**/ ?>