            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="<?php echo e(URL('/admin/categories/create')); ?>" id="sample_editable_1_new" class="btn sbold green"> Add New
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/categories/'. $item->id)); ?>"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/categories/'. $item->id .'/status')); ?>"><i class="icon-key"></i> <?php echo e($item->is_active ? 'Disable' : 'Enable'); ?> </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/categories/'. $item->id .'/edit')); ?>"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/resources/index.blade.php ENDPATH**/ ?>