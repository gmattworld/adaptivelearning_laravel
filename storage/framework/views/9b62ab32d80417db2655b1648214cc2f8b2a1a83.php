        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Users Management</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a href="<?php echo e(URL('/admin/users/create')); ?>" id="sample_editable_1_new" class="btn sbold green"> Add New
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        <?php if(count($model) > 0): ?>
                            <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $item->othernames; ?></td>
                                    <td><?php echo e($item->user_type_id == 0? "Student" : $item->user_type->name); ?></td>
                                    <td>
                                        <span class="label label-sm <?php echo e($item->is_logged_out ? 'label-success' : 'label-danger'); ?>"> <?php echo e($item->is_logged_out ? 'Active' : 'Disabled'); ?> </span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/users/'. $item->id)); ?>"><i class="icon-eye"></i> View Details </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/users/'. $item->id .'/status')); ?>"><i class="icon-key"></i> <?php echo e($item->is_logged_out ? 'Disable' : 'Enable'); ?> </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL('/admin/users/'. $item->id .'/edit')); ?>"><i class="icon-pencil"></i> Edit </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                        ...
                        <?php else: ?>
                            <tr><td colspan="7" class="text-center"> <h3>No User created yet</h3> </td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/admin/users/index.blade.php ENDPATH**/ ?>