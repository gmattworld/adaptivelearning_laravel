...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-fixed page-md">
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php echo $__env->make('inc.student.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
...
<?php /**PATH C:\Dev\laravel\adaptivelearning\src\resources\views/layouts/student.blade.php ENDPATH**/ ?>