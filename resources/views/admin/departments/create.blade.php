                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            {!! Form::open(['action' => 'DepartmentController@store', 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']) !!}
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::select('school_id', $schools, null, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select School']) !!}
