                ...
                <div class="tab-pane active" id="tab_2">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            {!! Form::open(['action' => ['ResourceController@update', $model->id], 'files'=>true, 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']) !!}
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::select('subject_id', $subjects, $model->subject_id, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Select Subject']) !!}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::file('pdf_path', ['class'=>'form-control']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    {!! Form::text('video_path', $model->video_path, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' Video URL']) !!}
