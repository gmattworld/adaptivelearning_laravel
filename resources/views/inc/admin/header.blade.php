...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-actions">
            <div class="h2" style="margin-top: 1px;"><strong>{{ config('utility.org_name', '') }}</strong></div>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="{{ URL::asset('admin/assets/layouts/layout3/img/avatar2.jpg') }}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="{{ URL::asset('admin/assets/layouts/layout3/img/avatar3.jpg') }}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                            <span class="photo">
                                                <img src="{{ URL::asset('admin/assets/layouts/layout3/img/avatar1.jpg') }}" class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="{{ URL::asset('storage/DPs/'.auth()->user()->dp_image ) }}" />
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            @if (auth()->user()->user_type_id == 0)
                                <li>
                                    <a href="{{ URL('/admin/adaptive') }}">
                                        <i class="icon-user"></i> Change Content Type </a>
                                </li>
                            @endif

                            <li>
                                <a href="{{ URL('/admin/changepwd') }}">
