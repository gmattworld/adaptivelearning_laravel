...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ URL::asset('admin/assets/pages/css/error.min.css') }}" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <!-- END THEME LAYOUT STYLES -->
        <link rel="shortcut icon" href="{{ URL::asset('admin/favicon.ico') }}" /> </head>
    <!-- END HEAD -->

    <body class=" page-404-3">
        <div class="page-inner">
            <img src="{{ URL::asset('admin/assets/pages/media/pages/earth.jpg') }}" class="img-responsive" alt=""> </div>
