...
<div>
    <div>
        {!! Form::open(['action' => 'ResourceController@filter', 'files'=>true, 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'form_validation']) !!}
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('level_id', $levels, $selectedlevel, ['class'=>'form-control', 'required'=>'required', 'placeholder'=>' All']) !!}
                                <span class="text-danger"> {!! $errors->first('level_id'); !!} </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2 text-center">
                        {!! Form::submit('Filter', ['class'=>'btn green']) !!}
                    {{-- </div>
                    <div class="col-md-2 text-center"> --}}
                        <a href="{{ URL('/admin/resources') }}" class="btn default">Reset</a>
                    </div>
                </div>
            </div>
        {!! Form::close() !!}
